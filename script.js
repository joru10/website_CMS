...
function applyTranslations(lang) {
    ...
    const translations = {
        ...
        'es': {
            ...
            'stat-speed': '50% más rápido',
            'stat-speed-label': 'Implementación de IA',
            'values-cta-title': '¿Listo para ver estos valores en acción?',
            'values-cta-subtitle': 'Hablemos de cómo nuestro enfoque puede transformar tu negocio con IA.',
            'stat-projects': 'Proyectos de IA entregados',
            'stat-satisfaction': 'Tasa de satisfacción del cliente',
            'stat-efficiency': 'Mejora media de eficiencia',
            'newsletter-placeholder': 'Introduce tu correo de empresa',
            'newsletter-join': 'Únete gratis',
            'newsletter-note': 'Gratis para siempre. Sin spam. Cancela tu suscripción en cualquier momento. Más de 2.000 líderes de pymes confían en nosotros.',
            ...
            'services-subtitle': 'Soluciones de IA rápidas y efectivas adaptadas a las necesidades de tu negocio',
            'service1-title': 'Estrategia y Consultoría IA',
            'service1-description': 'Desarrollo integral de estrategia de IA para identificar oportunidades y crear hojas de ruta de implementación para tu negocio.',
            ...
            'service2-description': 'Optimiza tus operaciones con soluciones de automatización inteligente que reducen costes y aumentan la eficiencia.',
            ...
            'service3-title': 'Soluciones de IA Personalizadas',
            'service3-description': 'Aplicaciones de IA personalizadas diseñadas específicamente para tu sector y tus necesidades de negocio.',
            ...
            // About Section
            'about-title': 'Conoce a Jose Ruiz',
            ...
            'process-subtitle': 'Un proceso claro de 4 pasos que te lleva de la incertidumbre a los resultados',
            'process-step1-title': 'Programa una Consulta de Preparación para IA',
            'process-step1-desc': 'Analizamos las necesidades de tu negocio e identificamos las oportunidades de IA de mayor impacto. Evaluación clara, sin agobios.',
            'process-step2-title': 'Evalúa tus Oportunidades de IA',
            'process-step2-desc': 'Entendemos las necesidades de tu negocio y vemos exactamente cómo la IA puede ayudar. Hoja de ruta a medida, próximos pasos claros.',
            'process-step3-title': 'Revisa el Plan de Implementación',
            ...
            'contact-company': 'Nombre de la compañía',
            'contact-industry': 'Industria',
            'contact-select-industry': 'Elige industria',
            'contact-industry-retail': 'Retail',
            ...
            'contact-placeholder': 'Cuéntame sobre los desafíos de tu negocio y tus objetivos de IA...',
